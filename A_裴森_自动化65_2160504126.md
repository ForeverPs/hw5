...
&ensp;&ensp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq1.gif /> <br><br>
&emsp;其中,`D(u,v)`代表在点`(u,v)`到频谱的中心点`(M/2,N/2)`的欧式距离，<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq2.gif />代表高斯分布的标准差。在使用时，用`D0`来代替，代表截止频率。它的分布特性从 **图片1** 中可以清楚的看到。<br>
&emsp;&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\gaussian.png width=550 height=300/><br> 
**<center>图片1.频域高斯滤波器</center>**<br>
&emsp;同样，巴特沃斯滤波器也是根据距离来定义的，只不过相对于高斯滤波器，它还多了阶数这个变量，并且需要指定滤波器的半径。它的定义式如下：<br><br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq3.gif /><br><br>
...
* 为了加快`DFT`的运算过程，做`DFT`的点数应当为<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq4.gif />。因此，在对行或列进行`padding`操作时要注意这一点。
* 从二维傅里叶变换返回时空域，只需要对频域结果再进行一次二维傅里叶变换，然后取实部并除以`MN`，这里`MN`是频域中图像的点数。<br>

&emsp;上述过程可以用公式表示为：<br><br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq5.gif /><br><br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq6.gif /><br><br>
&emsp;根据上述分析，可以得到频域滤波的一般步骤：<br>
* 对图像进行补零操作<br>

* <img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq7.gif /><br><br>
...
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\l_gau.png width=600 height=350/><br><br>
 **<center>图片2. 频域高斯低通</center>**<br>
* 采用巴特沃斯低通滤波器，处理图像为`test1`，半径`D=80`，阶数`n=2`，能量占比为`98.460%`，处理效果如下：
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\l_butt.png width=600 height=350/><br><br>
  **<center>图片3. 频域巴特沃斯低通</center>**<br>
 * 采用高斯低通滤波器，处理图像为`test2`，半径`D=100`，能量占比为`98.652%`，处理效果如下：
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\l_gau2.png width=600 height=350/><br><br>
 **<center>图片4. 频域高斯低通</center>**<br>
 * 采用巴特沃斯低通滤波器，处理图像为`test2`，半径`D=80`，阶数`n=2`，能量占比为`98.566%`，处理效果如下：
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\l_butt2.png width=600 height=350/><br><br>
...
* 高斯高通滤波器：<br>
 <img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq8.gif /><br><br>
 * 巴特沃斯高通滤波器：<br>
  <img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq9.gif /><br><br>
...
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\h_gau3.png width=600 height=350/><br><br>
**<center>图片6. 频域高斯高通</center>**<br>
 * 巴特沃斯高通滤波器，处理图像为`test3`，半径`D=50`，阶数`n=2`，能量比为`0.234%`，效果如下：<br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\h_butt3.png width=600 height=350/><br><br>
...
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\h_gau4.png width=600 height=350/><br><br>
**<center>图片8. 频域高斯高通</center>**<br>
 * 巴特沃斯高通滤波器，处理图像为`test4`，半径`D=50`，阶数`n=2`，能量比为`0.974%`，效果如下：<br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\h_butt4.png width=600 height=350/><br><br>
...
&ensp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq10.gif /><br><br>
&ensp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq11.gif /><br><br>
&emsp;上面的表达式是在时空域完成的，只不过现在我们要在频域完成，表达式为：<br>

&ensp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq12.gif /><br><br>
&emsp;其中<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq13.gif />代表的是频域高通滤波器，可以采用前面介绍过的高斯高通或者巴特沃斯高通，<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\eq14.gif />代表的是原图像的二维傅里叶变换。最后，由频域转换到时空域的方法与前面介绍的一样。对测试图像的处理结果如下：<br>
* 高斯高通滤波器(`1-低通`)，其中低通滤波器的半径`D=100`，系数`k1=0.75,k2=0.25`，得到图像`test3`的处理结果为：<br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\unmask3.png width=600 height=350/><br><br>
**<center>图片10. Unmask & Gaussian</center>**<br>
* 巴特沃斯高通滤波器，其中低通滤波器的半径`D=50`，阶数`n=2`，系数`k1=0.75,k2=0.25`，得到图像`test3`的处理结果为：<br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\unmask32.png width=600 height=350/><br><br>
**<center>图片11. Unmask & Butterworth</center>**<br>
* 高斯高通滤波器(`1-低通`)，其中低通滤波器的半径`D=100`，为了加强效果，修改系数为`k1=0.5,k2=0.75`，得到图像`test4`的处理结果为：<br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\unmask33.png width=600 height=350/><br><br>
**<center>图片12. Unmask & Gaussian</center>**<br>
* 巴特沃斯高通滤波器，其中低通滤波器的半径`D=50`，阶数`n=2`，为了加强显示效果，修改系数为`k1=0.5,k2=0.75`，得到图像`test3`的处理结果为：<br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第5次作业\unmask34.png width=600 height=350/><br><br>
